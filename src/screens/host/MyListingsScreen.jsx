...
const styles = StyleSheet.create({
  ...
  name: { flex: 1, fontSize: font.h3, fontWeight: '900', color: colors.ink },
  rating: { flexDirection: 'row', alignItems: 'center', gap: 3, marginLeft: 8 },
  ratingIcon: { width: 13, height: 13, tintColor: colors.star },
  ratingText: { fontSize: font.small, fontWeight: '800', color: colors.ink },
