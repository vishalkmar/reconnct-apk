...
export default function SupplierListingBookingsScreen({ listing }) {
    ...
    <View style={{ flex: 1, backgroundColor: colors.bg }}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => {
          ...
          return (
            <TouchableOpacity style={styles.bk} activeOpacity={0.8} onPress={() => push('supplierBookingDetail', { id: item.id, listingTitle: listing && listing.title })}>
